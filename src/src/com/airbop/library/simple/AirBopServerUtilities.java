...
//import static com.airbop.library.simple.CommonUtilities.AIRBOP_APP_KEY;
//import static com.airbop.library.simple.CommonUtilities.AIRBOP_APP_SECRET;
...
public class AirBopServerUtilities {
    ...
    private static final String PREFERENCES = "com.airbop.library.simple.data";
    ...
    private String constructSignatureURI(
    		...
    		, final String body
    		, final String airbop_appkey
    		, final String airbop_appsecret) {
    	/**
    	...
    	// APP_KEY
    	uriBuilder.append(airbop_appkey);
    	// timestamp
    	uriBuilder.append(timestamp);
    	// body
    	uriBuilder.append(body);
    	// ssssshhhhhh
    	uriBuilder.append(airbop_appsecret);
     ...
     */
    private void post(String url_endpoint
			, final boolean isRegister
			, final boolean asJSON
			, final String airbop_appkey
			, final String airbop_appsecret)
    ...
    static boolean register(final Context context
		...
		for (int i = 1; i <= MAX_ATTEMPTS; i++) {
		    ...
		    try {
		        ...
		        displayMessage(context, AirBopStrings.airbop_server_registered);
		    	...
		    	if ((error_code >= 400) && (error_code <= 499)) {
		        	displayMessage(context
		        			, String.format(AirBopStrings.airbop_request_error
		        	...
		        	displayMessage(context
		        			, String.format(
		        					AirBopStrings.airbop_server_reg_failed
		        					, error_code
		        					, error_msg));
		...
		String message = String.format(AirBopStrings.airbop_server_register_error,
		        MAX_ATTEMPTS);
    ...
    static boolean unregister(final Context context
		...
		try {
			...
			displayMessage(context, AirBopStrings.airbop_server_unregistered);
		} catch (IOException e) {
